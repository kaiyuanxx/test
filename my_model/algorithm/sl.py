...
class SLModel(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        output, recon_imgs = self.encoder(images) 
        ...
        self.val_step_outputs['recon_loss'] = nn.L1Loss()(recon_imgs, images).item()   
        return pred
    ...
    def on_validation_epoch_end(self):
        ...
        results['recon_loss'] = self.val_step_outputs['recon_loss']
